 ...
 * @author lio
 */
public class setearImagenAB extends HttpServlet {
...
ServletFileUpload upload = new ServletFileUpload(factory);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
              ...
              archivo.graficar_dot_Arbol_B();//generar grafica del arbol
        byte [] resultado=null;  
              ServletContext sc = getServletContext();
                
              //String filename = sc.getRealPath(File.separator+ File.separator + "arbolCliente.dot.png");
             
              String filename = sc.getRealPath("arbolBCliente.dot.png");
