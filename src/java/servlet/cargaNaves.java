 ...
 * @author lio
 */
public class cargaNaves extends HttpServlet {
...
ServletFileUpload upload = new ServletFileUpload(factory);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            archivo.lectura_navescsv(request);
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(cargaNaves.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
