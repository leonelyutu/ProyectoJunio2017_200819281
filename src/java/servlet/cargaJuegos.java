 ...
 * @author lio
 */
public class cargaJuegos extends HttpServlet {
...
ServletFileUpload upload = new ServletFileUpload(factory);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            archivo.lectura_juegoscsv(request);
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(cargaJuegos.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
